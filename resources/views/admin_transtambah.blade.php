 ...
 <div class="col-md-6">
    ...
    @csrf
        <div class="form-group">
            ...
            <input type="date" style="width: 50%" class="form-control" name="tgl_cuci" id="tgl_cuci" >
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">Jam Cuci</label>
            <input type="time" style="width: 50%" class="form-control" name="jam_cuci" id="jam_cuci" >
        </div>
        <div class="form-group">
