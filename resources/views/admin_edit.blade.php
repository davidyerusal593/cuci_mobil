...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" align="center"><h3>Validasi Pembayaran</h3></div>

                <div class="card-body">
                <form method="POST" action="/admin/transaksi/updated/{{ $trans->id_transaksi }}">
            @csrf
            @method('PUT')
            <input type="hidden" class="form-control" name="id_transaksi" id="id_transaksi" value="{{ $trans->id_transaksi }}">
                <div class="col-md-6">
