...
<div class="container">
 ...
 <div class="col-md-6">
    ...
    @csrf
        ...
        <div class="form-group">
            <input type="hidden" style="width: 50%" class="form-control" name="name" id="name" value="{{ Auth::user()->name }}" readonly>
        ...
        <div class="form-group">
            ...
            <input type="file" style="width: 50%" class="form-control" name="bukti_bayar" id="bukti_bayar" placeholder="Bukti Bayar">
        </div>
